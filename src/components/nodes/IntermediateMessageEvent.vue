<template>
  <div class="bpmn-node intermediate-message-event" :class="{ selected }">
    <svg
      :width="data.width || 50"
    ...
    >
      ...
      <rect x="15" y="18" width="20" height="14" stroke="#9b59b6" stroke-width="1.5" fill="none" />
      <polyline points="15,18 25,26 35,18" stroke="#9b59b6" stroke-width="1.5" fill="none" />
    </svg>
    <Handle
      id="input"
      type="target"
